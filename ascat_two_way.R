...
ascat.bc_fibro_tum = ascat.aspcf(ascat.bc_fibro_tum, out.dir = args[7])
ascat.plotSegmentedData(ascat.bc_fibro_tum , img.dir = args[7])
ascat.output_fibro_tum = ascat.runAscat(ascat.bc_fibro_tum, gamma = 0.55, img.dir = args[7])
